...
{
public:
    BooleanStateCluster(EndpointId endpointId) : DefaultServerCluster({ endpointId, BooleanState::Id }) {}
    ...
    /// Implementation
    bool StateValue() const { return mStateValue; }
    void SetStateValue(bool value);

private:
    bool mStateValue = false;
};
