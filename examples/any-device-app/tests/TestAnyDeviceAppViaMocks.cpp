...
class TestAnyDeviceApp : public ::testing::Test
{
public:
...
TEST_F(TestAnyDeviceApp, GetContactSensorAppDataModel)
{
...
TEST_F(TestAnyDeviceApp, GetLightingAppDataModel)
{
