...
{
public:
    using OptionalAttributeSet = chip::app::OptionalAttributeSet<AccessControl::Attributes::Extension::Id, 
                                                                AccessControl::Attributes::CommissioningARL::Id, 
                                                                AccessControl::Attributes::Arl::Id>;

    AccessControlCluster(OptionalAttributeSet optionalAttributeSet) : DefaultServerCluster({kRootEndpointId, AccessControl::Id}), mOptionalAttributeSet(optionalAttributeSet) {}
...
private:
    ...
    void OnEntryChanged(const chip::Access::SubjectDescriptor * subjectDescriptor, FabricIndex fabric, size_t index,
                                            const chip::Access::AccessControl::Entry * entry, chip::Access::AccessControl::EntryListener::ChangeType changeType) override;
    ...
    //                                                          Optional<CharSpan> instruction, Optional<CharSpan> arlRequestFlowUrl) override;
    std::optional<DataModel::ActionReturnStatus> HandleReviewFabricRestrictions(CommandHandler * commandObj, const ConcreteCommandPath & commandPath, const Clusters::AccessControl::Commands::ReviewFabricRestrictions::DecodableType & commandData);
#endif
};
